...
const page = () => {
	return (
		<>
			...
			<Box
				display={"flex"}
				paddingBottom={{ sm: "35px", base: "23px", lg: "23px" }}
				flexWrap={"wrap"}
			...
			>
				...
				<Box mr={"3%"} ml={"3%"} width={"700px"}>
					...
					<Box
						...
						marginBottom={{ lg: "23px", md: "20px", sm: "32px", base: "32px" }}
					>
						<Box display={"flex"} mt="2px" mb="20px">
							<Box>
								<img
									src="locationiconpi.png"
									width={"32px"}
									height={"32px"}
									alt="Location"
								/>
						...
						<Box display={"flex"} alignItems={"center"} mt="2px" mb="20px">
							<Box>
								<img
									src="Icon.svg"
									width={"32px"}
							...
							<Text ml="8px">(+91) 2717453330</Text>
						</Box>
					</Box>
				</Box>
			</Box>
